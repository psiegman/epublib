...
public class EpubWriterTest {
    ...
    public void testBook1() throws IOException {
        ...
        Assert.assertEquals(Scheme.ISBN.getName(), CollectionUtil.first(readBook.getMetadata().getIdentifiers()).getScheme().getName());
    ...
    private Book createTestBook() throws IOException {
        ...
        book.getMetadata().addIdentifier(new Identifier(Scheme.ISBN, "987654321"));
        book.getMetadata().addAuthor(new Author("Joe", "Tester"));
